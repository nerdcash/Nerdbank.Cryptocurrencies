...
public abstract class Bip32HDWalletTestBase
{
	internal static readonly TestVector TestVector1 = new(
	...
	internal static readonly TestVector TestVector2 = new(
		...
		new TestVectorStep[]
		{
			...
			new(
				2147483647 | Bip32KeyPath.HardenedBit,
			...
			new(
				2147483646 | Bip32KeyPath.HardenedBit,
	...
	/// </summary>
	internal static readonly TestVector TestVector3 = new(
	...
	/// </summary>
	internal static readonly TestVector TestVector4 = new(
	...
	internal static void AssertEqual(string expectedBase58Encoding, ExtendedKeyBase actual)
	{
