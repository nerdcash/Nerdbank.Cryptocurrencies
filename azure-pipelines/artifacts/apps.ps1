...
$VelopackBasePath = "$RepoRoot/obj/src/Nerdbank.Zcash.App/Nerdbank.Zcash.App.Desktop/$BuildConfiguration/net8.0"
if (!(Test-Path $VelopackBasePath)) { $VelopackBasePath = Join-Path (Split-Path $VelopackBasePath) 'net8.0-windows10.0.22621.0' }
