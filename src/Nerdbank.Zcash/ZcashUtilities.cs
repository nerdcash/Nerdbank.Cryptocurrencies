...
public static class ZcashUtilities
{
	...
	/// <summary>
	/// Converts ZEC at ZATs.
	/// </summary>
	/// <param name="zec">The amount in ZECs.</param>
	/// <returns>The amount in ZATs.</returns>
	internal static ulong ZecToZats(decimal zec) => (ulong)(zec * ZatsPerZEC);
