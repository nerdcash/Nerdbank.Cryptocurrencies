...
internal struct RustBuffer {
    ...
    public static RustBuffer Alloc(int size) {
        return _UniffiHelpers.RustCall((ref RustCallStatus status) => {
            var buffer = _UniFFILib.ffi_LightWallet_6dfb_rustbuffer_alloc(size, ref status);
    ...
    public static void Free(RustBuffer buffer) {
        _UniffiHelpers.RustCall((ref RustCallStatus status) => {
            _UniFFILib.ffi_LightWallet_6dfb_rustbuffer_free(buffer, ref status);
        });
    }
...
static class _UniFFILib {
    ...
    public static extern ulong LightWallet_6dfb_lightwallet_initialize(RustBuffer @config,RustBuffer @walletInfo,
    ref RustCallStatus _uniffi_out_err
    );

    [DllImport("nerdbank_zcash_rust")]
    public static extern ulong LightWallet_6dfb_lightwallet_initialize_from_disk(RustBuffer @config,
    ref RustCallStatus _uniffi_out_err
    );

    [DllImport("nerdbank_zcash_rust")]
    public static extern sbyte LightWallet_6dfb_lightwallet_deinitialize(ulong @handle,
    ref RustCallStatus _uniffi_out_err
    );

    [DllImport("nerdbank_zcash_rust")]
    public static extern RustBuffer LightWallet_6dfb_lightwallet_sync(ulong @handle,
    ref RustCallStatus _uniffi_out_err
    );

    [DllImport("nerdbank_zcash_rust")]
    public static extern void LightWallet_6dfb_lightwallet_sync_interrupt(ulong @handle,
    ref RustCallStatus _uniffi_out_err
    );

    [DllImport("nerdbank_zcash_rust")]
    public static extern RustBuffer LightWallet_6dfb_lightwallet_sync_status(ulong @handle,
    ref RustCallStatus _uniffi_out_err
    );

    [DllImport("nerdbank_zcash_rust")]
    public static extern ulong LightWallet_6dfb_lightwallet_get_birthday_height(ulong @handle,
    ref RustCallStatus _uniffi_out_err
    );

    [DllImport("nerdbank_zcash_rust")]
    public static extern ulong LightWallet_6dfb_last_synced_height(ulong @handle,
    ref RustCallStatus _uniffi_out_err
    );

    [DllImport("nerdbank_zcash_rust")]
    public static extern RustBuffer LightWallet_6dfb_lightwallet_get_transactions(ulong @handle,uint @startingBlock,
    ref RustCallStatus _uniffi_out_err
    );

    [DllImport("nerdbank_zcash_rust")]
    public static extern RustBuffer LightWallet_6dfb_lightwallet_send_to_address(ulong @handle,RustBuffer @sendDetails,
    ref RustCallStatus _uniffi_out_err
    );

    [DllImport("nerdbank_zcash_rust")]
    public static extern RustBuffer LightWallet_6dfb_lightwallet_send_check_status(ulong @handle,
    ref RustCallStatus _uniffi_out_err
    );

    [DllImport("nerdbank_zcash_rust")]
    public static extern RustBuffer LightWallet_6dfb_lightwallet_get_balances(ulong @handle,
    ref RustCallStatus _uniffi_out_err
    );

    [DllImport("nerdbank_zcash_rust")]
    public static extern RustBuffer ffi_LightWallet_6dfb_rustbuffer_alloc(int @size,
    ref RustCallStatus _uniffi_out_err
    );

    [DllImport("nerdbank_zcash_rust")]
    public static extern RustBuffer ffi_LightWallet_6dfb_rustbuffer_from_bytes(ForeignBytes @bytes,
    ref RustCallStatus _uniffi_out_err
    );

    [DllImport("nerdbank_zcash_rust")]
    public static extern void ffi_LightWallet_6dfb_rustbuffer_free(RustBuffer @buf,
    ref RustCallStatus _uniffi_out_err
    );

    [DllImport("nerdbank_zcash_rust")]
    public static extern RustBuffer ffi_LightWallet_6dfb_rustbuffer_reserve(RustBuffer @buf,int @additional,
    ref RustCallStatus _uniffi_out_err
    );
...
public static class LightWalletMethods {
    ...
    _UniFFILib.LightWallet_6dfb_lightwallet_initialize(FfiConverterTypeConfig.INSTANCE.Lower(@config), FfiConverterTypeWalletInfo.INSTANCE.Lower(@walletInfo), ref _status)
));
    }
    ...
    public static UInt64 LightwalletInitializeFromDisk(Config @config) {
        return FfiConverterULong.INSTANCE.Lift(
    _UniffiHelpers.RustCallWithError(FfiConverterTypeLightWalletError.INSTANCE, (ref RustCallStatus _status) =>
    _UniFFILib.LightWallet_6dfb_lightwallet_initialize_from_disk(FfiConverterTypeConfig.INSTANCE.Lower(@config), ref _status)
));
    }
    ...
    _UniFFILib.LightWallet_6dfb_lightwallet_deinitialize(FfiConverterULong.INSTANCE.Lower(@handle), ref _status)
));
    }
    ...
    _UniffiHelpers.RustCallWithError(FfiConverterTypeLightWalletError.INSTANCE, (ref RustCallStatus _status) =>
    _UniFFILib.LightWallet_6dfb_lightwallet_sync(FfiConverterULong.INSTANCE.Lower(@handle), ref _status)
));
    }
    ...
    _UniffiHelpers.RustCallWithError(FfiConverterTypeLightWalletError.INSTANCE, (ref RustCallStatus _status) =>
    _UniFFILib.LightWallet_6dfb_lightwallet_sync_interrupt(FfiConverterULong.INSTANCE.Lower(@handle), ref _status)
);
    }
    ...
    _UniffiHelpers.RustCallWithError(FfiConverterTypeLightWalletError.INSTANCE, (ref RustCallStatus _status) =>
    _UniFFILib.LightWallet_6dfb_lightwallet_sync_status(FfiConverterULong.INSTANCE.Lower(@handle), ref _status)
));
    }
    ...
    public static UInt64 LightwalletGetBirthdayHeight(UInt64 @handle) {
        return FfiConverterULong.INSTANCE.Lift(
    _UniffiHelpers.RustCallWithError(FfiConverterTypeLightWalletError.INSTANCE, (ref RustCallStatus _status) =>
    _UniFFILib.LightWallet_6dfb_lightwallet_get_birthday_height(FfiConverterULong.INSTANCE.Lower(@handle), ref _status)
));
    }
    ...
    public static UInt64 LastSyncedHeight(UInt64 @handle) {
        return FfiConverterULong.INSTANCE.Lift(
    _UniffiHelpers.RustCallWithError(FfiConverterTypeLightWalletError.INSTANCE, (ref RustCallStatus _status) =>
    _UniFFILib.LightWallet_6dfb_last_synced_height(FfiConverterULong.INSTANCE.Lower(@handle), ref _status)
));
    }
    ...
    _UniffiHelpers.RustCallWithError(FfiConverterTypeLightWalletError.INSTANCE, (ref RustCallStatus _status) =>
    _UniFFILib.LightWallet_6dfb_lightwallet_get_transactions(FfiConverterULong.INSTANCE.Lower(@handle), FfiConverterUInt.INSTANCE.Lower(@startingBlock), ref _status)
));
    }
    ...
    _UniffiHelpers.RustCallWithError(FfiConverterTypeLightWalletError.INSTANCE, (ref RustCallStatus _status) =>
    _UniFFILib.LightWallet_6dfb_lightwallet_send_to_address(FfiConverterULong.INSTANCE.Lower(@handle), FfiConverterSequenceTypeTransactionSendDetail.INSTANCE.Lower(@sendDetails), ref _status)
));
    }
    ...
    _UniffiHelpers.RustCallWithError(FfiConverterTypeLightWalletError.INSTANCE, (ref RustCallStatus _status) =>
    _UniFFILib.LightWallet_6dfb_lightwallet_send_check_status(FfiConverterULong.INSTANCE.Lower(@handle), ref _status)
));
    }
    ...
    _UniffiHelpers.RustCallWithError(FfiConverterTypeLightWalletError.INSTANCE, (ref RustCallStatus _status) =>
    _UniFFILib.LightWallet_6dfb_lightwallet_get_balances(FfiConverterULong.INSTANCE.Lower(@handle), ref _status)
));
    }
