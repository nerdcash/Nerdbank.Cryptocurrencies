...
class FfiConverterTypeBirthdayHeights: FfiConverterRustBuffer<BirthdayHeights> {
    ...
    public override BirthdayHeights Read(BigEndianStream stream) {
        return new BirthdayHeights(
            @originalBirthdayHeight: FfiConverterUInt64.INSTANCE.Read(stream),
            @birthdayHeight: FfiConverterUInt64.INSTANCE.Read(stream),
            @rebirthHeight: FfiConverterOptionalUInt64.INSTANCE.Read(stream)
        );
    }
...
class FfiConverterTypeConfig: FfiConverterRustBuffer<Config> {
    ...
    public override Config Read(BigEndianStream stream) {
        return new Config(
            @serverUri: FfiConverterString.INSTANCE.Read(stream),
            @chainType: FfiConverterTypeChainType.INSTANCE.Read(stream),
            @dataDir: FfiConverterString.INSTANCE.Read(stream),
            @walletName: FfiConverterString.INSTANCE.Read(stream),
            @logName: FfiConverterString.INSTANCE.Read(stream),
            @monitorMempool: FfiConverterBoolean.INSTANCE.Read(stream),
            @minimumConfirmations: FfiConverterUInt32.INSTANCE.Read(stream)
        );
    }
...
class FfiConverterTypeOrchardNote: FfiConverterRustBuffer<OrchardNote> {
    ...
    public override OrchardNote Read(BigEndianStream stream) {
        return new OrchardNote(
            ...
            @recipient: FfiConverterByteArray.INSTANCE.Read(stream)
        );
    }
...
class FfiConverterTypePoolBalances: FfiConverterRustBuffer<PoolBalances> {
    ...
    public override PoolBalances Read(BigEndianStream stream) {
        return new PoolBalances(
            @saplingBalance: FfiConverterOptionalUInt64.INSTANCE.Read(stream),
            @verifiedSaplingBalance: FfiConverterOptionalUInt64.INSTANCE.Read(stream),
            @spendableSaplingBalance: FfiConverterOptionalUInt64.INSTANCE.Read(stream),
            @unverifiedSaplingBalance: FfiConverterOptionalUInt64.INSTANCE.Read(stream),
            @orchardBalance: FfiConverterOptionalUInt64.INSTANCE.Read(stream),
            @verifiedOrchardBalance: FfiConverterOptionalUInt64.INSTANCE.Read(stream),
            @unverifiedOrchardBalance: FfiConverterOptionalUInt64.INSTANCE.Read(stream),
            @spendableOrchardBalance: FfiConverterOptionalUInt64.INSTANCE.Read(stream),
            @transparentBalance: FfiConverterOptionalUInt64.INSTANCE.Read(stream)
        );
    }
...
class FfiConverterTypeSendUpdate: FfiConverterRustBuffer<SendUpdate> {
    ...
    public override SendUpdate Read(BigEndianStream stream) {
        return new SendUpdate(
            ...
            @isSendInProgress: FfiConverterBoolean.INSTANCE.Read(stream),
            @progress: FfiConverterUInt32.INSTANCE.Read(stream),
            @total: FfiConverterUInt32.INSTANCE.Read(stream),
            @lastError: FfiConverterOptionalString.INSTANCE.Read(stream),
            @lastTransactionId: FfiConverterOptionalString.INSTANCE.Read(stream)
        );
    }
...
class FfiConverterTypeSyncResult: FfiConverterRustBuffer<SyncResult> {
    ...
    public override SyncResult Read(BigEndianStream stream) {
        return new SyncResult(
            ...
            @totalBlocksSynced: FfiConverterUInt64.INSTANCE.Read(stream)
        );
    }
...
class FfiConverterTypeSyncStatus: FfiConverterRustBuffer<SyncStatus> {
    ...
    public override SyncStatus Read(BigEndianStream stream) {
        return new SyncStatus(
            @inProgress: FfiConverterBoolean.INSTANCE.Read(stream),
            @lastError: FfiConverterOptionalString.INSTANCE.Read(stream),
            @syncId: FfiConverterUInt64.INSTANCE.Read(stream),
            @startBlock: FfiConverterUInt64.INSTANCE.Read(stream),
            @endBlock: FfiConverterUInt64.INSTANCE.Read(stream),
            @blocksDone: FfiConverterUInt64.INSTANCE.Read(stream),
            @trialDecDone: FfiConverterUInt64.INSTANCE.Read(stream),
            @txnScanDone: FfiConverterUInt64.INSTANCE.Read(stream),
            @blocksTotal: FfiConverterUInt64.INSTANCE.Read(stream),
            @batchNum: FfiConverterUInt64.INSTANCE.Read(stream),
            @batchTotal: FfiConverterUInt64.INSTANCE.Read(stream)
        );
    }
...
class FfiConverterTypeTransaction: FfiConverterRustBuffer<Transaction> {
    ...
    public override Transaction Read(BigEndianStream stream) {
        return new Transaction(
            ...
            @datetime: FfiConverterUInt64.INSTANCE.Read(stream),
            @blockHeight: FfiConverterUInt32.INSTANCE.Read(stream),
            @isIncoming: FfiConverterBoolean.INSTANCE.Read(stream),
            @spent: FfiConverterUInt64.INSTANCE.Read(stream),
            @received: FfiConverterUInt64.INSTANCE.Read(stream),
            @price: FfiConverterOptionalDouble.INSTANCE.Read(stream),
            @unconfirmed: FfiConverterBoolean.INSTANCE.Read(stream),
            @sends: FfiConverterSequenceTypeTransactionSendDetail.INSTANCE.Read(stream),
            @saplingNotes: FfiConverterSequenceTypeSaplingNote.INSTANCE.Read(stream),
            @orchardNotes: FfiConverterSequenceTypeOrchardNote.INSTANCE.Read(stream)
        );
    }
...
class FfiConverterTypeTransactionSendDetail: FfiConverterRustBuffer<TransactionSendDetail> {
    ...
    public override TransactionSendDetail Read(BigEndianStream stream) {
        return new TransactionSendDetail(
            ...
            @value: FfiConverterUInt64.INSTANCE.Read(stream),
            @recipientUa: FfiConverterOptionalString.INSTANCE.Read(stream),
            @memo: FfiConverterByteArray.INSTANCE.Read(stream)
        );
    }
