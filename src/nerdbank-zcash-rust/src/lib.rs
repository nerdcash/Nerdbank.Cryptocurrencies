...
use interop::{
    ...
    CancellationSource, ChainType, DbInit, LightWalletError, SendTransactionResult, SyncUpdate,
    SyncUpdateData, Transaction, TransactionNote, TransactionSendDetail, TransparentNote,
};
