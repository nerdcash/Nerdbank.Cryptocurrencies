...
internal class ShieldCommand : SyncFirstCommandBase
{
	...
	{
		Option<bool> shieldAllOption = new("--all")
		{
			Description = Strings.ShieldAllOptionDescription,
		};
		Option<string> memoOption = new("--memo")
		{
			Description = Strings.SendMemoOptionDescription,
		};
		Option<ulong> thresholdOption = new("--threshold")
		{
			Description = Strings.ShieldThresholdOptionDescription,
		};
